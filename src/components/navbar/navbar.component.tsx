    ...
    <div className="py-3 my-6 flex flex-row items-center justify-between">
      ...
      <div className="flex space-x-14">
        <ul className="flex items-center space-x-12 inter text-[#787878] font-medium text-base">
          <li><Link to={'/posts/design'}>Design</Link></li>
          <li><Link to={'/posts/ux'}>User Experience</Link></li>
          <li><Link to={'/posts/tech'}>Tech</Link></li>
          <li><Link to={'/posts/lifestyle'}>Lifestyle</Link></li>
          <li><Link to={'/posts/skincare'}>Skincare</Link></li>
